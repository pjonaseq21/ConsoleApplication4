...
sf::Vector2f Throngle::throngleTerritoryPosition(int familyId) {
    ...
    float firstFamilyS = screenW * 0.07;
    float firstFamilyE = screenW * 0.3;
    float secondFamilyS = screenW * 0.7;
    float secondFamilyE = screenW * 0.9;

    float yAxis = screenH * 0.7;
